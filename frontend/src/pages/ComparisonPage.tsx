...
import { Alert, Badge, Card, Descriptions, Empty, Space, Spin, Tag, Typography } from 'antd'
        ...
        <Space wrap style={{ marginTop: 8 }}>
          ...
          {activeDef && (
            <Typography.Text type="secondary" style={{ fontSize: 12 }}>
              ...
              {activeDef.suppliers(data).map((s) => s.supplier_name).join('、') || '无'}
              （再点一次徽标取消）
            </Typography.Text>
          )}
        </Space>
